# Copyright 2015-2017 Canonical Limited.
#
...
class RelationInfo(UserDict):
    ...
    def data(self):
        try:
            ...
            # A peer unit may not yet have joined the relation, and
            # attempting to access its data will fail. We can't tell
            # when they do join the relation, apart from attempting to
            # access their data.
            return {}
